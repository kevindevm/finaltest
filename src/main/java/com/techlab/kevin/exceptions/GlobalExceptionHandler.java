...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProductApiResponseDTO<Product>> handleIllegalArgument(IllegalArgumentException ex) {
    ...
    public ResponseEntity<ProductApiResponseDTO<Product>> handleProductNotFound(ProductNotFoundException ex) {
        return ResponseEntity
